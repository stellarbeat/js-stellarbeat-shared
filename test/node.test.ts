...
test('nodeToJson', () => {
    expect(JSON.stringify(node1)).toBe("{\"ip\":\"localhost\",\"port\":8080,\"publicKey\":\"123\",\"active\":false,\"overLoaded\":false," +
        ...
        "\"geoData\":{}," +
        "\"statistics\":{\"activeCounter\":0,\"overLoadedCounter\":0,\"activeRating\":0,\"activeInLastCrawl\":true," +
        "\"overLoadedInLastCrawl\":false,\"validatingInLastCrawl\":false,\"validatingCounter\":0,\"validatingRating\":0,\"active7DaysPercentage\":0," +
        "\"overLoaded7DaysPercentage\":0,\"validating7DaysPercentage\":0,\"active24HoursPercentage\":0,\"overLoaded24HoursPercentage\":0,\"validating24HoursPercentage\":0}," +
        "\"dateDiscovered\":\"2018-04-28T12:39:02.000Z\",\"dateUpdated\":\"2018-04-28T12:39:01.000Z\",\"isValidator\":false,\"isFullValidator\":false,\"isValidating\":false,\"index\":0,\"homeDomain\":\"my-domain\"}");
});
