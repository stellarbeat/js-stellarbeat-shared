...
class Node {
    constructor(ip, port = 11625, publicKey = undefined, active = false, overLoaded = false, quorumSet = new quorum_set_1.QuorumSet(), geoData = new node_geo_data_1.NodeGeoData(), statistics = new node_statistics_1.NodeStatistics(), dateDiscovered = new Date(), dateUpdated = new Date()) {
        this._ip = ip;
        this._port = port;
    ...
    static fromJSON(node) {
        ...
        newNode.quorumSet = quorum_set_1.QuorumSet.fromJSON(nodeObject.quorumSet);
        newNode.geoData = node_geo_data_1.NodeGeoData.fromJSON(nodeObject.geoData);
        newNode.statistics = node_statistics_1.NodeStatistics.fromJSON(nodeObject.statistics);
