...
class Node {
    ...
    constructor(ip, port, publicKey = undefined, active = false, overLoaded = false, quorumSet = new QuorumSet(), geoData = new GeoData(), statistics = new Statistics(), dateDiscovered = new Date(), dateUpdated = new Date() ) {
        this._ip = ip;
        this._port = port;
