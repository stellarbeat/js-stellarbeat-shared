...
const schema22 = {"$id":"https://stellarbeat.io/schemas/network.json","$ref":"#/definitions/Network","$schema":"http://json-schema.org/draft-07/schema#","definitions":{"Network":{"properties":{"time":{"format":"date-time","type":"string"},"statistics":{"$ref":"#/definitions/NetworkStatistics"},"id":{"type":"string"},"name":{"type":"string"},"nodes":{"items":{"$ref":"#/definitions/Node"},"type":"array"},"organizations":{"items":{"$ref":"#/definitions/Organization"},"type":"array"},"transitiveQuorumSet":{"items":{"type":"string"},"type":"array"},"scc":{"items":{"type":"array","items":{"type":"string"}},"type":"array"}},"additionalProperties":false,"type":"object","required":["nodes"]},"Node":{"properties":{"active":{"default":false,"type":"boolean"},"alias":{"type":"string"},"dateDiscovered":{"format":"date-time","type":"string"},"dateUpdated":{"format":"date-time","type":"string"},"displayName":{"type":"string"},"geoData":{"$ref":"#/definitions/NodeGeoData"},"historyUrl":{"type":"string"},"homeDomain":{"type":"string"},"host":{"type":"string"},"index":{"default":0,"type":"number"},"ip":{"default":"127.0.0.1","type":"string"},"isFullValidator":{"default":false,"type":"boolean"},"isValidating":{"default":false,"type":"boolean"},"isValidator":{"type":"boolean"},"isp":{"type":"string"},"key":{"type":"string"},"ledgerVersion":{"type":"string"},"name":{"type":"string"},"networkId":{"type":"string"},"organizationId":{"type":"string"},"overLoaded":{"default":false,"type":"boolean"},"overlayMinVersion":{"type":"string"},"overlayVersion":{"type":"string"},"port":{"type":"number"},"publicKey":{"type":"string"},"quorumSet":{"$ref":"#/definitions/QuorumSet"},"statistics":{"$ref":"#/definitions/NodeStatistics"},"versionStr":{"type":"string"}},"type":"object","required":["publicKey"],"additionalProperties":false},"NodeGeoData":{"properties":{"countryCode":{"type":"string"},"countryName":{"type":"string"},"latitude":{"type":"number"},"longitude":{"type":"number"}},"type":"object","additionalProperties":false},"NodeStatistics":{"properties":{"active24HoursPercentage":{"default":0,"type":"number"},"active30DaysPercentage":{"default":0,"type":"number"},"has24HourStats":{"default":false,"type":"boolean"},"has30DayStats":{"default":false,"type":"boolean"},"overLoaded24HoursPercentage":{"default":0,"type":"number"},"overLoaded30DaysPercentage":{"default":0,"type":"number"},"validating24HoursPercentage":{"default":0,"type":"number"},"validating30DaysPercentage":{"default":0,"type":"number"}},"type":"object","additionalProperties":false},"Organization":{"properties":{"dateDiscovered":{"format":"date-time","type":"string"},"dba":{"type":"string"},"description":{"type":"string"},"github":{"type":"string"},"has24HourStats":{"default":false,"type":"boolean"},"has30DayStats":{"default":false,"type":"boolean"},"horizonUrl":{"type":"string"},"id":{"type":"string"},"isTierOneOrganization":{"type":"boolean"},"keybase":{"type":"string"},"logo":{"type":"string"},"name":{"type":"string"},"officialEmail":{"type":"string"},"phoneNumber":{"type":"string"},"physicalAddress":{"type":"string"},"subQuorum24HoursAvailability":{"default":0,"type":"number"},"subQuorum30DaysAvailability":{"default":0,"type":"number"},"subQuorumAvailable":{"default":false,"type":"boolean"},"twitter":{"type":"string"},"url":{"type":"string"},"validators":{"default":[],"items":{"type":"string"},"type":"array"}},"type":"object","required":["id"],"additionalProperties":false},"QuorumSet":{"properties":{"hashKey":{"type":"string"},"innerQuorumSets":{"items":{"$ref":"#/definitions/QuorumSet"},"type":"array"},"threshold":{"type":"number"},"validators":{"items":{"type":"string"},"type":"array"}},"type":"object","required":[],"additionalProperties":false},"NetworkStatistics":{"properties":{"hasQuorumIntersection":{"type":"boolean"},"hasTransitiveQuorumSet":{"default":false,"type":"boolean"},"minBlockingSetFilteredSize":{"default":0,"type":"number"},"minBlockingSetOrgsFilteredSize":{"type":"number"},"minBlockingSetOrgsSize":{"type":"number"},"minBlockingSetSize":{"type":"number"},"minSplittingSetOrgsSize":{"type":"number"},"minSplittingSetSize":{"type":"number"},"nrOfActiveFullValidators":{"default":0,"type":"number"},"nrOfActiveOrganizations":{"default":0,"type":"number"},"nrOfActiveValidators":{"default":0,"type":"number"},"nrOfActiveWatchers":{"default":0,"type":"number"},"time":{"format":"date-time","type":"string"},"topTierFilteredSize":{"type":"number"},"topTierOrgsFilteredSize":{"type":"number"},"topTierOrgsSize":{"type":"number"},"topTierSize":{"type":"number"},"transitiveQuorumSetSize":{"default":0,"type":"number"}},"type":"object","additionalProperties":false}}};
const schema23 = {"properties":{"time":{"format":"date-time","type":"string"},"statistics":{"$ref":"#/definitions/NetworkStatistics"},"id":{"type":"string"},"name":{"type":"string"},"nodes":{"items":{"$ref":"#/definitions/Node"},"type":"array"},"organizations":{"items":{"$ref":"#/definitions/Organization"},"type":"array"},"transitiveQuorumSet":{"items":{"type":"string"},"type":"array"},"scc":{"items":{"type":"array","items":{"type":"string"}},"type":"array"}},"additionalProperties":false,"type":"object","required":["nodes"]};
...
const schema25 = {"properties":{"active":{"default":false,"type":"boolean"},"alias":{"type":"string"},"dateDiscovered":{"format":"date-time","type":"string"},"dateUpdated":{"format":"date-time","type":"string"},"displayName":{"type":"string"},"geoData":{"$ref":"#/definitions/NodeGeoData"},"historyUrl":{"type":"string"},"homeDomain":{"type":"string"},"host":{"type":"string"},"index":{"default":0,"type":"number"},"ip":{"default":"127.0.0.1","type":"string"},"isFullValidator":{"default":false,"type":"boolean"},"isValidating":{"default":false,"type":"boolean"},"isValidator":{"type":"boolean"},"isp":{"type":"string"},"key":{"type":"string"},"ledgerVersion":{"type":"string"},"name":{"type":"string"},"networkId":{"type":"string"},"organizationId":{"type":"string"},"overLoaded":{"default":false,"type":"boolean"},"overlayMinVersion":{"type":"string"},"overlayVersion":{"type":"string"},"port":{"type":"number"},"publicKey":{"type":"string"},"quorumSet":{"$ref":"#/definitions/QuorumSet"},"statistics":{"$ref":"#/definitions/NodeStatistics"},"versionStr":{"type":"string"}},"type":"object","required":["publicKey"],"additionalProperties":false};
const schema26 = {"properties":{"countryCode":{"type":"string"},"countryName":{"type":"string"},"latitude":{"type":"number"},"longitude":{"type":"number"}},"type":"object","additionalProperties":false};
const schema28 = {"properties":{"active24HoursPercentage":{"default":0,"type":"number"},"active30DaysPercentage":{"default":0,"type":"number"},"has24HourStats":{"default":false,"type":"boolean"},"has30DayStats":{"default":false,"type":"boolean"},"overLoaded24HoursPercentage":{"default":0,"type":"number"},"overLoaded30DaysPercentage":{"default":0,"type":"number"},"validating24HoursPercentage":{"default":0,"type":"number"},"validating30DaysPercentage":{"default":0,"type":"number"}},"type":"object","additionalProperties":false};
const schema27 = {"properties":{"hashKey":{"type":"string"},"innerQuorumSets":{"items":{"$ref":"#/definitions/QuorumSet"},"type":"array"},"threshold":{"type":"number"},"validators":{"items":{"type":"string"},"type":"array"}},"type":"object","required":[],"additionalProperties":false};
...
if(!((((key0 === "hashKey") || (key0 === "innerQuorumSets")) || (key0 === "threshold")) || (key0 === "validators"))){
validate23.errors = [{keyword:"additionalProperties",dataPath,schemaPath:"#/additionalProperties",params:{additionalProperty: key0},message:"should NOT have additional properties"}];
return false;
break;
}
}
...
const _errs1 = errors;
for(const key0 in data){
if(!(func8.call(schema25.properties, key0))){
validate22.errors = [{keyword:"additionalProperties",dataPath,schemaPath:"#/additionalProperties",params:{additionalProperty: key0},message:"should NOT have additional properties"}];
return false;
break;
}
}
...
if(!((((key1 === "countryCode") || (key1 === "countryName")) || (key1 === "latitude")) || (key1 === "longitude"))){
validate22.errors = [{keyword:"additionalProperties",dataPath:dataPath+"/geoData",schemaPath:"#/definitions/NodeGeoData/additionalProperties",params:{additionalProperty: key1},message:"should NOT have additional properties"}];
return false;
break;
}
}
...
if(!((((((((key2 === "active24HoursPercentage") || (key2 === "active30DaysPercentage")) || (key2 === "has24HourStats")) || (key2 === "has30DayStats")) || (key2 === "overLoaded24HoursPercentage")) || (key2 === "overLoaded30DaysPercentage")) || (key2 === "validating24HoursPercentage")) || (key2 === "validating30DaysPercentage"))){
validate22.errors = [{keyword:"additionalProperties",dataPath:dataPath+"/statistics",schemaPath:"#/definitions/NodeStatistics/additionalProperties",params:{additionalProperty: key2},message:"should NOT have additional properties"}];
return false;
break;
}
}
...
const _errs1 = errors;
for(const key0 in data){
if(!((((((((key0 === "time") || (key0 === "statistics")) || (key0 === "id")) || (key0 === "name")) || (key0 === "nodes")) || (key0 === "organizations")) || (key0 === "transitiveQuorumSet")) || (key0 === "scc"))){
validate21.errors = [{keyword:"additionalProperties",dataPath,schemaPath:"#/additionalProperties",params:{additionalProperty: key0},message:"should NOT have additional properties"}];
return false;
break;
}
}
...
if(!(func8.call(schema24.properties, key1))){
validate21.errors = [{keyword:"additionalProperties",dataPath:dataPath+"/statistics",schemaPath:"#/definitions/NetworkStatistics/additionalProperties",params:{additionalProperty: key1},message:"should NOT have additional properties"}];
return false;
break;
}
}
...
let missing1;
if((data25.id === undefined) && (missing1 = "id")){
...
if(!(func8.call(schema29.properties, key2))){
validate21.errors = [{keyword:"additionalProperties",dataPath:dataPath+"/organizations/" + i1,schemaPath:"#/definitions/Organization/additionalProperties",params:{additionalProperty: key2},message:"should NOT have additional properties"}];
return false;
break;
}
}
...
/*# sourceURL="https://stellarbeat.io/schemas/network.json" */;
let vErrors = null;
let errors = 0;
